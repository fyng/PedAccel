...
#kernal smoothing isn't quite working
    #filtered_sleeping = Smoothing_Functions.simple_ks(total_sleeping['VecMag'],total_sleeping['Time(s)'])
    #filtered_waking = Smoothing_Functions.simple_ks(total_waking['VecMag'],total_waking['Time(s)'])
...
MAD Data Histograms
    """
#MAD sleeping Data
    myX, MAD_sleeping = Actigraph_Metrics.MAD(total_sleeping, wlen=50)

#MAD waking data
    myX, MAD_waking = Actigraph_Metrics.MAD(total_waking, wlen=50)

    myX, MAD_waking_NM = Actigraph_Metrics.MAD(total_waking_NM, wlen=50)

    myX, MAD_non_moving = Actigraph_Metrics.MAD(total_non_moving, wlen=50)

    myX, MAD_In_Out = Actigraph_Metrics.MAD(In_Out_of_sleep, wlen=50)
